...
spec = do
  ...
  describe "half" $ do
    it "doubled half is the original" $
      property $ \n -> halfIdentity n == n
  describe "sorted list" $ do
    it "is ordered" $
      property $ \l -> listOrdered (sort (l :: [Int]))
  describe "addition" $ do
    it "is associative" $
  ...
  describe "multiplication" $ do
    it "is associative" $
      property multiplyAssociative
    it "is commutative" $
      property multiplyCommutative
  ...
  describe "subtraction" $ do
    it "is associative" $
      expectFailure subtractionAssociative
    it "is not commutative" $
      expectFailure subtractionCommutative
  describe "subtraction" $ do
    it "is associative" $
      expectFailure subtractionAssociative
  describe "reverse" $ do
  ...
  describe "combinators" $ do
    ...
    it "dot is function composition" $ do
      property $ \f g a -> ((applyFun f . applyFun g) a) == (applyFun f (applyFun g (a :: String) :: Int) :: String)
  ...
  describe "read" $ do
    it "is the inverse of show" $
      property $ \n -> read (show (n :: Int)) == n
  describe "square" $ do
    it "cannot always be undone with sqrt" $
      expectFailure squareIdentity
  describe "idempotence" $ do
    it "of capitalizeWord" $
      property $ \s -> capitalizeWord s == twice capitalizeWord s && capitalizeWord s == fourTimes capitalizeWord s
    it "of sort" $
      property $ \l -> sort l == twice sort l && sort l == fourTimes sort (l :: [Int])
  describe "cipher" $ do
